...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="images/hat1.jpg" width="100%" id="productImg">

            <div class="small-img-row">
                <div class="small-img-col">
                    <img src="images/hat1.jpg" width="100%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/hat11.jpg" width="100%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/hat12.jpg" width="100%" class="small-img">
                </div>
            </div>
        </div>
        <div class="col-2">
            <p>Home / Kids Hat</p>
            <h1>Cartoon Print Cap</h1>
            <h4>₹299.00</h4>
    ...
    <button type="submit" class="btn">Add To Cart</button>
            ...
            <p>Keep your child stylish and sun-safe with this vibrant Cartoon Print Summer Cap. Designed especially for kids, this cap features a fun, eye-catching cartoon character print that your child will love. Made from 100% breathable cotton, the cap ensures maximum comfort even on hot days. The adjustable strap at the back allows it to grow with your child, providing a perfect fit every time.</p>
        </div>
    </div>
</div>
