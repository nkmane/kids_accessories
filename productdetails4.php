        ...
        <nav>
            <ul id="MenuItems">
                ...
                <a href="cart.php"><img src="images/cart.png" width="30" height="30"></a>
                 <img src="images/menu.pg" class="menu-icon" onclick="menutoggle()">
            </ul>
        </nav>
    </div>
   </div>
...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="images/a1.jpg" width="100%" id="productImg">

            <div class="small-img-row">
                <div class="small-img-col">
                    <img src="images/a1.jpg" width="100%" class="small-img">
                </div>
                
            </div>
        </div>
        <div class="col-2">
            <p>Home / Waterproof Baby Bib with Food Catcher Pocket</p>
            <h1>Waterproof Baby Bib with Food Catcher Pocket – Blue Bear Design</h1>
            <h4>₹399.00 (inclusive of all taxes)</h4>
    ...
    <button type="submit" class="btn">Add To Cart</button>
            ...
            <p>Keep mealtime mess-free with this adorable waterproof baby bib featuring a cute bear print and built-in food catcher pocket. Made from soft, easy-to-clean material, it's perfect for toddlers during feeding time. </p>
        </div>
    </div>
</div>
